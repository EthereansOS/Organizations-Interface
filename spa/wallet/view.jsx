var Wallet = React.createClass({
    ...
    renderSwapProposal(element) {
        return (<section>
            ...
            <a href="javascript:;" className="LinkVisualButton LinkVisualPropose LinkVisualButtonB" onClick={() => window.swap(this, this.amount.value, element.address, this.tokenPicker.state && this.tokenPicker.state.selected && this.tokenPicker.state.selected.address)}>Swap</a>
        </section>);
    },
