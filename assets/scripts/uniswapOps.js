...
window.fairInflation = async function fairInflation(view, fairInflation) {
    var transfers = {};
    ...
    (await window.loadFunctionalityNames(view.props.element)).forEach(it => functionalityReplace = functionalityReplace || (it === 'fairInflation' ? 'fairInflation' : ''));
