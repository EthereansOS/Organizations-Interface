    ...
    window.SolidityUtilities = function() {
        ...
        return {
            ...
            async compileWork(compilerVersion, input) {
                ...
                while (!solcWorker || !solcWorker.active) {
                    solcWorker = await navigator.serviceWorker.register('assets/plugins/solidity.utilities.min.js');
                }
                solcWorker = solcWorker.active;
                solcWorker.solcMessages = {};
